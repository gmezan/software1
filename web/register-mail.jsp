<%-- 
    Document   : register-mail
    Created on : Nov 15, 2019, 1:30:40 PM
    Author     : Gustavo_Meza
--%>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Tu solicitud ha sido registrada! Los administradores revisarán tu solicitud.</h1>
