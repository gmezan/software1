<%-- 
    ...
    Created on : 16-nov-2019, 16:42:02
    Author     : Labtel
--%>
                ...
                <div id="content">
                    ...
                    <div class="container">
                        <h1 class="my-4">EDITAR EVENTO
                            <br></br>
                            <small>Edite los datos del evento seleccionado</small>
                        </h1>
                                    ...
                                    <form class='form-horizontal' role='form'>
                                            ...
                                            <div class='col-md-8'>
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_first_name' value="Actividad Mujeres" type='text'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class='col-md-8'>
                                                ...
                                                <div class='col-md-3 indent-small'>
                                                    <div class='form-group internal'>
                                                        <input class='form-control' id='id_first_name' value="DD/MM/AA" type='text'>
                                                    </div>
                                                </div>
                                        ...
                                        <div class='form-group'>
                                            <label class='control-label col-md-2 col-md-offset-2' >Añadir Imagen</label>
                                            <div class='col-md-3'>
                                                <img src="<%=request.getContextPath()%>/images/futsal.jpg">
                                            </div>
                                        ...
                                        <div class='form-group'>
                                            <div class='col-md-offset-4 col-md-3'>
                                                <button class='btn-lg btn-primary' type='button' onclick="location.href = 'DG_verActividades.html'">Guardar</button>
                                            </div>
                                        </div>

                                        <div class='form-group'>
                                            <div class='col-md-offset-4 col-md-3'>
                                                <button class='btn-lg btn-danger'  type='button' onclick="location.href = 'DG_verActividades.html'">Eliminar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
