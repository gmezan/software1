<%-- 
    Document   : forgot-mail
    Created on : Nov 15, 2019, 1:31:18 PM
    Author     : Gustavo_Meza
--%>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Te hemos enviado un correo para que puedas reestablecer tu contraseña. Revisa tu inbox o tu bandeja de spam</h1>
